...
def test_executor_meta_hook_duckdb_build_then_skip(tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("fastflowtransform.cli.bootstrap._load_project_and_env", fake_lpae)
    monkeypatch.setattr("fastflowtransform.cli.bootstrap._resolve_profile", fake_resolve)
